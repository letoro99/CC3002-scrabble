...
/**
 * This class represents the arithmetic operation subtraction.
 * */
public class Subtract implements IComponent {
    ArrayList<IComponent> components = new ArrayList<>();

    /**
     * Create a Subtract object with two component.
     * @param a a object that implements the IComponent interface.
     * @param b another object that implements the IComponent interface.
     * */
    public Subtract(IComponent a, IComponent b){
        this.addNode(a);
        this.addNode(b);
    }
    ...
    public IVar execute(IVisitor visitor) {
        return visitor.executeSubtract(this);
    }
