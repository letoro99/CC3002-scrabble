...
/**
 * This class represents the arithmetic operation multiplication.
 * */
public class Multi implements IComponent {
    ArrayList<IComponent> components = new ArrayList<>();

    /**
     * Create a Multi object with two component.
     * @param a a object that implements the IComponent interface.
     * @param b another object that implements the IComponent interface.
     * */
    public Multi(IComponent a, IComponent b){
        this.addNode(a);
        this.addNode(b);
    }
    ...
    public IVar execute(IVisitor visitor) {
        return visitor.executeMulti(this);
    }
