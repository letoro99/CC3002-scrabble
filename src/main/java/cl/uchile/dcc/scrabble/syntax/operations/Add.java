...
/**
 * This class represents the arithmetic operation addition.
 * */
public class Add implements IComponent {
    ArrayList<IComponent> components = new ArrayList<>();

    /**
     * Create a Add object with two component.
     * @param a a object that implements the IComponent interface.
     * @param b another object that implements the IComponent interface.
     * */
    public Add(IComponent a, IComponent b){
        this.addNode(a);
        this.addNode(b);
    }
    ...
    public IVar execute(IVisitor visitor){
        return visitor.executeAdd(this);
    }
